...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 07, 2020 at 05:56 AM
...
(49, 2, 11, 2, 5, 'a', 'Menunggu'),
(50, 9, 1, 1, 6, 'a', 'Menunggu'),
(51, 9, 1, 1, 6, 'a', 'Menunggu'),
(52, 9, 1, 1, 6, 'aa', ''),
(53, 9, 1, 1, 6, 'aaa', 'Menunggu'),
(54, 9, 1, 1, 6, 'abc', 'Menunggu'),
(55, 9, 1, 1, 6, 'aaaaabbcc', 'Menunggu'),
(56, 9, 1, 2, 7, 'coba', 'Menunggu'),
(57, 9, 1, 2, 7, 'test\r\n', 'Menunggu');
...
(66, '2', 11, 2, 5, '15.26 WIB', 'Dikonfirmasi', '', 'Belum Absen'),
(67, '2', 11, 4, 7, '15.27 WIB', 'Menunggu', '15.29 WIB', 'Menunggu');
...
(8, 'a@a.a', '86f7e437faa5a7fce15d1ddcb9eaeaea377667b8', 'sw'),
(9, 'vi@vi.vi', 'a642a77abd7d4f51bf9226ceaf891fcbb5b299b8', 'sw');
...
--
ALTER TABLE `catatan`
  MODIFY `id_cat` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=58;
